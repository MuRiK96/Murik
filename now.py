...
#         pass
#     pass 
# # print(FristClass.__dict__)
# #способ создания экземпляра класса (обьекта)
# first_exp1 = FristClass()
# # print(first_exp1.__dict__)
# # first_exp1.color = 'red'
# # print(first_exp1.color)
# second_exp1 = FristClass()
# # second_exp1.color = 'black'
# # print(second_exp1.color)
# print(first_exp1,first_exp1.__init__)


# class Cats:
#     def __init__(self):
#         self.name = input('ввдите имя котэ')
#         self.age = input('lvl')
# my_cat = Cats()
